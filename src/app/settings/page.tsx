        ...
        <section className="bg-white rounded-3xl border border-neutral-200/80 shadow-2xs overflow-hidden">
          <div className="p-6 sm:p-8 space-y-6">
            <div className="flex items-center gap-3 border-b border-neutral-100 pb-4">
              ...
              <div>
                <h2 className="font-heading text-lg font-extrabold text-neutral-900">Notifications</h2>
                <p className="text-xs text-neutral-500">Gérez comment nous vous contactons.</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-2xl bg-neutral-50 border border-neutral-100">
                <div>
                  <h3 className="text-sm font-bold text-neutral-900">Notifications par e-mail</h3>
                  <p className="text-xs text-neutral-500 mt-1">Recevoir des actualités, promotions et alertes sur votre compte.</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-2xl bg-neutral-50 border border-neutral-100">
                <div>
                  <h3 className="text-sm font-bold text-neutral-900">Notifications dans l'application</h3>
                  <p className="text-xs text-neutral-500 mt-1">Être alerté lorsque des annonces ou générations d'IA sont terminées.</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
        ...
        <section className="bg-white rounded-3xl border border-neutral-200/80 shadow-2xs overflow-hidden">
          <div className="p-6 sm:p-8 space-y-6">
            <div className="flex items-center gap-3 border-b border-neutral-100 pb-4">
              ...
              <div>
                <h2 className="font-heading text-lg font-extrabold text-neutral-900">Légal & Confidentialité</h2>
                <p className="text-xs text-neutral-500">Consultez nos politiques et conditions.</p>
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/privacy" className="flex items-center gap-3 p-4 rounded-2xl border border-neutral-100 hover:border-neutral-200 hover:bg-neutral-50 transition-all group">
                <div className="p-2 rounded-xl bg-neutral-100 text-neutral-500 group-hover:text-secondary group-hover:bg-orange-50 transition-colors">
                  <Shield className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-neutral-900">Politique de confidentialité</h3>
                  <p className="text-[10px] text-neutral-500">Comment nous protégeons vos données</p>
                </div>
              </Link>
              
              <Link href="/terms" className="flex items-center gap-3 p-4 rounded-2xl border border-neutral-100 hover:border-neutral-200 hover:bg-neutral-50 transition-all group">
                <div className="p-2 rounded-xl bg-neutral-100 text-neutral-500 group-hover:text-secondary group-hover:bg-orange-50 transition-colors">
                  <FileText className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-neutral-900">Conditions d'utilisation</h3>
                  <p className="text-[10px] text-neutral-500">Règles d'utilisation du service</p>
                </div>
              </Link>
            </div>
          </div>
