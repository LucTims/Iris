...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-neutral-50 text-neutral-900 antialiased selection:bg-primary selection:text-white">
      ...
      >
        ...
        <div className="p-3 border-t border-neutral-200 bg-neutral-50/80 space-y-2">
          ...
          <button
            ...
            className="hidden lg:flex items-center justify-center w-full py-2 rounded-xl text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100 transition-colors text-xs font-medium gap-2"
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-neutral-200 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link
              href="/dashboard"
              className="hidden md:inline-flex items-center gap-1.5 text-xs font-semibold text-neutral-500 hover:text-neutral-900 px-3 py-1.5 rounded-lg border border-neutral-200 hover:border-neutral-300 transition-colors"
            >
