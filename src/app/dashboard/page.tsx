      ...
      <main className="p-4 sm:p-6 md:p-8 max-w-6xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-neutral-200/80 shadow-2xs flex flex-col justify-between">
            ...
            <div>
              <span className="font-heading font-bold text-2xl text-neutral-900 block mb-0.5">
                {projects.length} {projects.length > 1 ? "ouvrages" : "ouvrage"}
              </span>
              <span className="text-xs text-neutral-500">Projets en cours de rédaction</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-neutral-200/80 shadow-2xs flex flex-col justify-between">
            ...
            <div>
              ...
              <span className="text-xs text-neutral-500">Temps de rédaction économisé</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-neutral-200/80 shadow-2xs flex flex-col justify-between">
            ...
            <div>
              ...
              <span className="text-xs text-neutral-500">Livres finalisés</span>
            </div>
          </div>
        ...
        <div className="space-y-4 pt-2">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-heading font-bold text-lg text-neutral-900">Mes Projets de Livres</h3>
              <p className="text-xs text-neutral-500">Poursuivez la rédaction de vos ouvrages en cours</p>
            </div>
            <Link href="/projects/new">
              <button className="bg-white border border-neutral-200 hover:border-neutral-300 text-neutral-800 text-xs font-semibold px-3.5 py-2 rounded-xl transition-colors shadow-2xs">
                + Nouveau Livre
              </button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:gap-4">
            {projects.map((book) => (
              <div 
                key={book.id} 
                className="bg-white rounded-2xl border border-neutral-200/80 p-4 sm:p-5 shadow-2xs hover:border-neutral-300 transition-all flex flex-col md:flex-row items-start md:items-center justify-between gap-4"
              >
                <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                  <div className="w-11 h-14 rounded-lg bg-neutral-100 border border-neutral-200 flex items-center justify-center text-neutral-400 shrink-0 overflow-hidden shadow-2xs">
                    {book.cover_url ? (
                  ...
                  <div className="space-y-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-semibold uppercase tracking-wider text-neutral-700 bg-neutral-100 px-2 py-0.5 rounded">
                    ...
                    <h4 className="font-heading font-bold text-base text-neutral-900 truncate">
                      {book.title}
                    </h4>
                ...
                <div className="w-full md:w-auto shrink-0 flex items-center gap-2 pt-2 md:pt-0">
                  <button
                    ...
                    className="bg-neutral-50 hover:bg-neutral-100 border border-neutral-200/80 text-neutral-700 text-xs font-semibold px-3 py-2 rounded-xl transition-colors flex items-center justify-center gap-1.5"
        ...
        <div className="space-y-4 pt-4">
          <div>
            <h3 className="font-heading font-bold text-lg text-neutral-900">Espaces de travail</h3>
            <p className="text-xs text-neutral-500">Accédez directement aux modules de conception et de publication</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            
            {/* Tool 1 */}
            <div className="bg-white rounded-2xl p-5 border border-neutral-200/80 shadow-2xs flex flex-col justify-between space-y-4 hover:border-neutral-300 transition-colors">
              <div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-neutral-200/80 shadow-2xs flex flex-col justify-between space-y-4 hover:border-neutral-300 transition-colors">
              <div>
                ...
                <h4 className="font-heading font-bold text-sm sm:text-base text-neutral-900 mb-1">Studio de Couvertures</h4>
                <p className="text-xs text-neutral-500 leading-relaxed">Concevez des couvertures professionnelles calibrées pour Amazon KDP, Apple Books et l&apos;impression.</p>
              </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-neutral-200/80 shadow-2xs flex flex-col justify-between space-y-4 hover:border-neutral-300 transition-colors">
              <div>
                ...
                <h4 className="font-heading font-bold text-sm sm:text-base text-neutral-900 mb-1">Exportation Multi-Formats</h4>
                <p className="text-xs text-neutral-500 leading-relaxed">Téléchargez vos manuscrits complets aux formats PDF éditeur, EPUB ebook et Word (.docx).</p>
              </div>
              <Link href="/projects">
                <button className="w-full bg-neutral-50 hover:bg-neutral-100 text-neutral-800 text-xs font-semibold py-2 rounded-xl border border-neutral-200/80 transition-colors">
