  ...
  return (
    <section className="bg-gradient-to-r from-[#8B2615] via-[#C84B31] to-[#A8321D] py-16 md:py-20 overflow-hidden relative shadow-inner">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mb-10">
        ...
        <p className="text-lg md:text-xl text-[#FDF3F1]/90 font-medium max-w-2xl mx-auto">
      ...
      <div className="relative z-10 flex whitespace-nowrap overflow-hidden py-4">
        ...
        <div className="absolute top-0 left-0 w-12 md:w-32 h-full bg-gradient-to-r from-[#8B2615] to-transparent z-20 pointer-events-none"></div>
        <div className="absolute top-0 right-0 w-12 md:w-32 h-full bg-gradient-to-l from-[#A8321D] to-transparent z-20 pointer-events-none"></div>
